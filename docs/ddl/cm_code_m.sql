...
COMMENT ON TABLE CM_CODE_M IS '공통코드 마스터';
COMMENT ON COLUMN CM_CODE_M.main_cd IS '코드 그룹 (예: PACK_UNIT)';
COMMENT ON COLUMN CM_CODE_M.sub_cd IS '코드값 (예: EA, CS)';
COMMENT ON COLUMN CM_CODE_M.code_nm IS '다국어 코드명 JSONB {"ko":"개","en":"EA"}';
COMMENT ON COLUMN CM_CODE_M.code_info IS 'JSONB use_yn, disp_seq 등';
...
-- 판매구분(SALES_TYPE): docs/dml/cm_code_m_data_store_currency.sql 에 등록됨
-- =============================================================================
