...
export const BO_APP_ROUTES: BoAppRouteDef[] = [
  ...
  { path: '/order', menuId: 'order-domestic-b2c', tabId: 'order-domestic-b2c', titleKey: 'orders.titleDomesticB2c' },
  { path: '/order/overseas-b2c', menuId: 'order-overseas-b2c', tabId: 'order-overseas-b2c', titleKey: 'orders.titleOverseasB2c' },
  { path: '/order/domestic-b2b', menuId: 'order-domestic-b2b', tabId: 'order-domestic-b2b', titleKey: 'orders.titleDomesticB2b' },
  { path: '/order/overseas-b2b', menuId: 'order-overseas-b2b', tabId: 'order-overseas-b2b', titleKey: 'orders.titleOverseasB2b' },
  { path: '/order/other', menuId: 'order-other', tabId: 'order-other', titleKey: 'orders.titleOther' },
  { path: '/order/unmatched', menuId: 'order-unmatched', tabId: 'order-unmatched', titleKey: 'boPages.unmatched_orders' },
  { path: '/order/claim', menuId: 'order-claim', tabId: 'order-claim', titleKey: 'boPages.claim_orders' },
  { path: '/product', menuId: 'product-info', tabId: 'product-info', titleKey: 'products.title' },
  { path: '/product/edit', menuId: 'product-info', tabId: 'product-info', titleKey: 'products.detail.title' },
  { path: '/product/gift', menuId: 'product-gift', tabId: 'product-gift', titleKey: 'boPages.product_gift' },
  { path: '/product/matching', menuId: 'product-matching', tabId: 'product-matching', titleKey: 'boPages.product_matching' },
  { path: '/mall', menuId: 'mall-list', tabId: 'mall-list', titleKey: 'malls.title' },
  { path: '/mall/connection', menuId: 'mall-connection', tabId: 'mall-connection', titleKey: 'boPages.mall_connection' },
